                ...
                <div class="card-content">
                    <ul>
                        ...
                        <li>
                            ...
                            <div style="display: inline-block; width: 250px;"></div> 
                            <div style="display: inline-block; width: 210px;">
                                <span>{{ intval($project->projectProduct->estimate_power) }} (kWh)</span>
                            </div>
                        </li>
                        <li>
                            <div style="display: inline-block; width: 210px; text-align: right;">
                            ...
                            <div style="display: inline-block; width: 250px;"></div> 
                            <div style="display: inline-block; width: 210px;">
                                <span>{{ $project->projectProduct->panel_count }}</span>
                            </div>
                        </li>
                        <li>
                            <div style="display: inline-block; width: 210px; text-align: right;">
                            ...
                            <div style="display: inline-block; width: 250px;"></div> 
                            <div style="display: inline-block; width: 210px;">
                                <span>{{ $project->projectProduct->quantity }}</span>
                            </div>
                        </li>
                        <li>
                            <div style="display: inline-block; width: 210px; text-align: right;">
                ...
                <div class="card-content">
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $transformer->product->descricao }}</td>
                                <td class="text-center" style="width: 109.5px;">{{ $transformer->quantity }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="width: 109.5px;">
                                    {{ $component->getQuantity() * $project->projectProduct->quantity }}
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
